...
<!-- 타이핑 애니메이션: 검정 -->
<a href="https://github.com/shin-sang-hoon">
  <img src="https://readme-typing-svg.herokuapp.com?font=Noto+Sans+KR&weight=600&size=22&duration=3500&pause=800&color=000000&center=true&vCenter=true&width=760&lines=배워야%20하는%20신입이%20아닌%2C%20즉시%20일할%20수%20있는%20개발자;6개월%20국비과정%20최우수상%20—%20반에서%20가장%20우수한%20성적으로%20수료;Spring%20Boot%20%2B%20React%20%2B%20Python%20AI%20%7C%20Full-Stack%20Developer;끝맺지%20않은%20프로젝트는%20단%20하나도%20없습니다" alt="Typing intro"/>
</a>
...
<font size="5"><b>신상훈</b></font> · <font size="4"><i>Shin Sang-hoon</i></font>
...
### **"9년 사장의 실행력을 코드로 옮깁니다."**

<font size="4">

저는 **9년간 알레르망 김포사우점을 직접 운영**해 온 자영업 경험을 발판으로 개발자의 길에 들어선 **39세 신입 풀스택 개발자** 신상훈입니다.

매장의 성패가 결국 **시스템과 데이터를 얼마나 잘 다루는가**에 달려 있다는 사실을 매일 체감하며, 사용자가 아닌 **시스템을 직접 만드는 사람**이 되기로 결심했습니다.

2025년 12월, 안정적인 사업장을 아버지에게 인계하고 풀스택 국비 과정을 시작했습니다. **2026년 6월 수료까지 6개월 동안 단 한 번의 결석·지각 없이** 모든 과정에 임했고, 팀 프로젝트와 개인 프로젝트를 모두 **끝까지 책임지고 완성**하며 풀스택 흐름을 처음부터 끝까지 체득했습니다. 이러한 6개월간의 노력의 결과로 **각 항목별 평가에서 가장 우수한 성적을 획득하여, 수료식에서 🏆 최우수상을 수여받았습니다.**

> 신입의 자리에서 배우러 가는 것이 아닙니다.
> **자영업으로 단련된 책임감**과 **직접 부딪히며 익힌 풀스택 구현 능력**을
> 곧바로 회사의 가치로 전환하기 위해 지원합니다.
...
### 🏪
<font size="5"><b>9년 자영업의 실행력</b></font>
...
### 🏆
<font size="5"><b>6개월 무결석 → 최우수상</b></font>
...
### 🎯
<font size="5"><b>시작한 일은 끝까지</b></font>

<font size="4">

팀 프로젝트 **MUREAM** —
5개 핵심 기능 영역을 직접 책임지고
25일 만에 완성.
...
<font size="4"><b>의류 렌탈·경매 쇼핑몰 + AI 챗봇</b></font>

<font size="4">

> 무신사(스타일) × 크림(거래) 컨셉을 결합한
> 풀스택 웹 서비스
...
<font size="4"><b>기계식 키보드 판매·경매 + 3D 빌더 + AI 챗봇</b></font>
...
> 모든 트러블슈팅은 **검색해도 답이 안 나오는 영역**을 직접 부딪히며 해결한 경험입니다.
...
#### 🚨 [MUREAM] Mixed Content 차단 이슈

<font size="4">

**문제** — HTTPS 프론트엔드 ↔ HTTP 백엔드 사이의 모든 API 요청을 브라우저가 차단

**해결** — 인증서 발급 일정이 빠듯해서 **CloudFront Behavior 규칙으로 EC2 프록시 구성** → 단일 HTTPS 도메인으로 통일

**배운 점** — 풀스택 개발자가 가져야 할 시야는 **인프라 + 프론트 + 백엔드를 함께 보는 눈**
...
**문제** — Seq2Seq LSTM 300 epoch 학습 후에도 858개 QA로는 답변 품질이 일관되지 않음

**해결** — 생성형 → **검색형 모델로 구조 전환** TF-IDF 후보 20개 → KoBERT 의미 유사도 → 최종 선택 **하이브리드 구조 + 6개 카테고리 폴백 UX**

**배운 점** — 모델 선택은 무조건 최신 기술이 아니라 **데이터 양과 도메인 특성에 맞춰야 한다**
...
**해결** — 기능 폐기 대신 **비즈니스 컨셉을 전환**. **"한정판 키보드 중고 경매"** 로 재설계해 관리자가 **30~70% 할인율 + 상품 상태**를 선택 가능하게 구현 → WebSocket 실시간 호가는 그대로 유지.
...
<img src="./assets/award_certificate.jpg" width="360" alt="최우수상 증서"/>

<br/>

<font size="3"><b>최우수상 증서</b></font>

</td>
<td width="58%" align="center" valign="top">

<img src="./assets/award_ceremony.jpg" width="460" alt="K-디지털트레이닝 수료 시상식"/>

<br/>

<font size="3"><b>K-디지털트레이닝 수료 시상식</b></font>
...
> 🏆 **2026.06 · 더조은컴퓨터아카데미 K-디지털트레이닝 과정 최우수상**
> 6개월 전 과정의 **각 항목별 평가에서 가장 우수한 성적을 획득**하여, **타의 모범**이 되어 수여받은 상입니다. 성실함(무결석)과 실력을 객관적으로 인정받은 결과입니다.
...
**2025.12.01 ~ 2026.06.17 수료** · MSA 기반 Java 풀스택 웹/앱 개발 과정 (K-디지털트레이닝)

- 🏆 **수료식 최우수상 수상** — 전 과정 평가에서 가장 우수한 성적으로 타의 모범
- 6개월 전 과정 **무결석·무지각**
...
### *"개발자의 실력은 코드를 시작할 때가 아니라 마무리할 때 드러납니다.*
### *지금까지 시작한 어떤 프로젝트든 끝맺지 않은 적이 없습니다."*
